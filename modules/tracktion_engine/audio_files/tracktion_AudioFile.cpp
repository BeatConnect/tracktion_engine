...
: SmartThumbnail (
    ...
    componentToRepaint, 
    ed,
    e.getUIBehaviour().createAudioThumbnail (
        256,
        e.getAudioFileFormatManager().readFormatManager,
        e.getAudioFileManager().getAudioThumbnailCache()))
{}

SmartThumbnail::SmartThumbnail (Engine& e, const AudioFile& f, juce::Component& componentToRepaint, Edit* ed, std::unique_ptr<juce::AudioThumbnailBase> thumbnailToUse)
: file (f)
, engine (e)
, edit (ed)
