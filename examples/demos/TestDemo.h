...
//  /_____/\___/\__,_/\__/\____/\____/_/ /_/_/ /_/\___/\___/\__/____/\____/____/ /_/         ©2024     //
//																									   //
/////////////////////////////////////////////////////////////////////////////////////////////////////////                                                                                   
...
#include "../../../Source/Plugin/bc_BitCrusherPlugin.cpp"

class BitCrusherDemo : public Component, private ChangeListener
{
public:
    BitCrusherDemo(Engine& p_engine) : engine(p_engine)
	{
        // Register our custom plugin with the engine so it can be found using PluginCache::createNewPlugin
        engine.getPluginManager().createBuiltInType<BeatConnect::BitCrusherPlugin>();
        ...
        // Creates new instance of BitCrusherPlugin and inserts to track 1
        auto plugin = edit.getPluginCache().createNewPlugin(BeatConnect::BitCrusherPlugin::xmlTypeName, {});
        ...
        std::string debugPluginState = plugin->state.toXmlString().toStdString();
        int breakpoint = 8888;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(BitCrusherDemo)
};

static DemoTypeBase<BitCrusherDemo> BitCruscherDemo("BitCrusher Demo");